...
- We highly recommend you check out our simple **[Copilot Textarea Tutorial](/tutorial-textarea/overview)**.
    
## Reference

For further details, see [`CopilotTextare Reference`](/reference/components/CopilotTextarea)
